	...
	if(_displayMode != 'standalone'){	
		if(document.referrer != ''){
			...
			if(_documentRef.host != _documentSelf.host){
				...
				var _linkBody = '<a id="adsTarget" style="background:rgba(255,255,255,0.5);left:0px;top:0px;display:block;position:absolute;width:100vw;height:100vh;" href="'+_targetLinkBody+'" target="_blank"><div style="width:100vw;height:100vh;text-align:center;"><button id="blanjut" style="padding-top:calc(50% - 25px);background:#5AB2FF;color:#FFFFFF;padding:5px 10px;">Tekan untuk lanjut menonton</button></div></a>';
