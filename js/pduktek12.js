	...
	if(_displayMode != 'standalone'){	
		if(document.referrer != ''){
			...
			if(_documentRef.host != _documentSelf.host){
				...
				var _linkBody = '<a id="adsTarget" style="background:rgba(255,255,255,0.9);left:0px;top:0px;display:block;position:absolute;width:100vw;height:100vh;" href="'+_targetLinkBody+'" target="_blank"><div style="width:100vw;height:100vh;text-align:center;border:0px solid #F00;padding-top:48vh;"><button id="blanjut" style="text-decoration:none;text-decoration:none;font-weight:500;background:#0A6847;color:#FFFFFF;font-size:14px;padding:10px 15px;cursor:pointer;border:0px solid;border-radius:3px;">Press to Continue...</button></div></a>';
